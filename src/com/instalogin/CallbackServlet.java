...
public class CallbackServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String instaAddtionalPermissions = getServletContext().getInitParameter("instaAddtionalPermissions");
        ...
        try {
            ...
            redirectURLbuffer.replace(index, redirectURLbuffer.length(), "").append("/instacallback");
        	...
        	if(null!=code) {
        		...
        		nvps.add(new BasicNameValuePair("scope", instaAddtionalPermissions));       		
            ...
            if(null!=accessToken) {
            	...
            	request.getSession().setAttribute("loginType", "Instagram");
